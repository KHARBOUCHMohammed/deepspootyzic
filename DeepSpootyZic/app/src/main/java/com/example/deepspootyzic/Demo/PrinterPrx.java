...
public interface PrinterPrx extends com.zeroc.Ice.ObjectPrx
{
    ...
    default String[] SearchTitle(String title)
    {
        return SearchTitle(title, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default String[] SearchTitle(String title, java.util.Map<String, String> context)
    {
        return _iceI_SearchTitleAsync(title, context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<String[]> SearchTitleAsync(String title)
    {
        return _iceI_SearchTitleAsync(title, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<String[]> SearchTitleAsync(String title, java.util.Map<String, String> context)
    {
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<String[]> _iceI_SearchTitleAsync(String iceP_title, java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<String[]> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "SearchTitle", null, sync, null);
        f.invoke(true, context, null, ostr -> {
    ...
    default String[] SearchArtist(String artist)
    {
        return SearchArtist(artist, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default String[] SearchArtist(String artist, java.util.Map<String, String> context)
    {
        return _iceI_SearchArtistAsync(artist, context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<String[]> SearchArtistAsync(String artist)
    {
        return _iceI_SearchArtistAsync(artist, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<String[]> SearchArtistAsync(String artist, java.util.Map<String, String> context)
    {
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<String[]> _iceI_SearchArtistAsync(String iceP_artist, java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<String[]> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "SearchArtist", null, sync, null);
        f.invoke(true, context, null, ostr -> {
